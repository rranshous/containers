...
# FROM https://github.com/ihabunek/toot/blob/30857f570d64a26da80d0024227a8259f7cb65b5/toot/commands.py#L61
# override to set the screen width as a higher number, for using timeline output in scripting
# default width cuts media hrefs between lines
